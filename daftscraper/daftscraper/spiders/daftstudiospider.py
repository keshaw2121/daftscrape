...
class StudiospiderSpider(CrawlSpider):
    name = "studiospider"
    ...
    rules = (
        ...
        Rule(LinkExtractor(allow = 'studio', deny = ['from', 'overseas', 'parking', 'commercial', 'student']), callback = 'parse_item',follow = True)
    )
    ...
    def parse_item(self, response):
        ...
        loader.add_value("beds", str(1))
        loader.add_value("baths", str(1))
